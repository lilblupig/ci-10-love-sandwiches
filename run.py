...
def validate_data(values):
    ...
    Raises ValueError if strings cannot be converted into integers, or if there are not exactly 6 values.
    """
...
def update_worksheet(data, worksheet):
    ...
    Updates the relevant worksheet with that data
    """
...
def get_last_5_entries_sales():
    """
    Collects columns of data from sales worksheet, using only the last 5 entries.
    Returns the data for each sandwich type as a list of lists.
    """
...
def calculate_stock_data(data):
    """
    Calculate average sales for last five markets of each type of sandwich
    """
